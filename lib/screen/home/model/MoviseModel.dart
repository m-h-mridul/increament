...
MoviseModel pokedexFromJson(String str) => MoviseModel.fromJson(json.decode(str));

String pokedexToJson(MoviseModel data) => json.encode(data.toJson());
...
class MoviseModel {
    ...
    factory MoviseModel.fromJson(Map<String, dynamic> json) => MoviseModel(
        id: json["id"],
        url: json["url"],
        name: json["name"],
        type: json["type"],
